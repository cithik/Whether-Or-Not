<%-- 
    Document   : LoginPage
    Created on : Apr 9, 2015, 8:37:43 PM
		...
		<form role="form" action = "val.jsp">
			<fieldset>
				...
				<div class="row">
					...
					<div class="col-xs-6 col-sm-6 col-md-6">
                                        <!-- <a href="userRegistration.jsp" class="btn btn-primary btn-block">New User</a>
					-->
                                        <input type ="submit" class ="btn btn-primary btn-block" value ="Register" onclick="document.forms[0].action = 'userRegistration.jsp'; return true;" >
            ...
            <center>      <img src="http://kpsforestry.com/images/login_icon.jpg" height="400" width="400">
        </center>
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					...
					<div class="text-center">
						<a href="LoginPage.jsp" class="totop"><i class="fa fa-angle-up fa-3x"></i></a>
